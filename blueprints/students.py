...
def student_details(student_id):
    ...
    try:
        ...
        financial_aid = {
            ...
            'opensign_document_status': tuition_record.opensign_document_status if tuition_record else None,
            'opensign_signed_url': tuition_record.opensign_signed_url if tuition_record else None,
            'opensign_certificate_url': tuition_record.opensign_certificate_url if tuition_record else None,
